...
// one day this will be a sealed interface...
/**
 * Represents an object that holds a "next url" that can be used to automatically fetch the next
 * page of results.
 */
interface Pageable {
    /** The next URL for this pageable. */
    val nextUrl: String?
}
